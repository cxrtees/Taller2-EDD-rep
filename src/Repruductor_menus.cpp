...
void Reproductor::menuTop() {
    while (true) {
        ...
        char c = op[0];
        if (c >= 'a' && c <= 'z') c = c - 'a' + 'A';
        if (c == 'C') { menuTopCanciones(); }
        else if (c == 'A') { menuTopArtistas(); }
        else if (c == 'X') return;
    }
}
...
void Reproductor::menuTopCanciones() {
    while (true) {
        ...
        if (cantTop == 0) {
            ...
            string op = leerLinea();
            if (op.empty() || op[0] == 'V' || op[0] == 'v') return;
            if (op[0] == 'A' || op[0] == 'a') { menuTopArtistas(); return; }
            return;
        }
        ...
        // 'A' sin número → top artistas
        if ((op[0] == 'A' || op[0] == 'a') && op.size() == 1) {
            menuTopArtistas(); return;
        }
        if (op[0] == 'V' || op[0] == 'v') return;
...
void Reproductor::menuTopArtistas() {
    while (true) {
        ...
        if (cantTop == 0) {
            ...
            string op = leerLinea();
            if (op.empty() || op[0] == 'V' || op[0] == 'v') return;
            if (op[0] == 'C' || op[0] == 'c') { menuTopCanciones(); return; }
            return;
        }
        ...
        if (op.empty()) continue;
        if (op[0] == 'V' || op[0] == 'v') return;
        if ((op[0] == 'C' || op[0] == 'c') && op.size() == 1) { menuTopCanciones(); return; }
